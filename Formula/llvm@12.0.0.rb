class LlvmAT1200 < Formula
  ...
  # https://github.com/llvm/llvm-project/issues/49365
  patch do
    url "https://github.com/llvm/llvm-project/commit/b8e4d4eafeded48f3c07797a2d8ccc950394085e.patch?full_index=1"
    sha256 "fdb894f0fe1b90983838eadcb394c5cf0cd3adaace4cf5c22f5fc91ab96ccd40"
  end

  # Use consistent checks for XDR
  #
  # Backported because SANITIZER_APPLE used to be SANITIZER_MAC.
  #
  # https://reviews.llvm.org/D130060
  # https://github.com/llvm/llvm-project/commit/28800c2e18972935cd4f942aa428c5e6cc4c1670
  patch do
    url "https://gist.githubusercontent.com/nox/1a944266643cfd0a8b75aa56bdd957c5/raw/6abbf4ccf7774d2cd2a0eec9ca45f5c89793a55b/llvm-12-apple-xdr-checks.patch"
    sha256 "6af01fcf313149d54d3671e05f82a0f662182332720cef5bb0fbcc03aad4583c"
  end
